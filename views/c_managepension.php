<div class="container p-5">
    ...
    <div class="float-end d-none" id="loading">
       ...
       <table class="table table-striped" id="myTable">
            ...
            <tbody>
                <?php $services->showRequestPension();?>
...
<!-- Approve Pension Date Pick Modal -->
<div class="modal fade" id="dateRange" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="datePickerPension">
        <div class="form-group mt-4">
            <label for="exampleInputEmail1" class="form-label"><b>Date Release</b>&nbsp;<span style="color: red; font-weight: 600;">*</span></label><br>
            <input type="date" class="form-control" id="datePickerInput" name="dateReleasePension" required>
            <input type="hidden" class="form-control" id="idSelected" name="id_item_pensionReq" required>
        </div>
      </div>
...
$(".approveReqPension").on('click',function(){
    ...
    $("#submitDate").click(function(){
      var formData = $("#datePickerPension").serialize()+"&approveSelectedPension=approveSelectedPension";
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response == "Success"){
                        Swal.fire({
                        title: 'Success!',
                        text: "Pension Request was Approved!",
                        icon: 'success',
    ...
    $(".disapproveReqPension").on('click',function(){
        id_item = $(this).attr('id');
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: "../Controller/AdminFunction.php",
                data: {id_item_pensionReq : id_item,disapproveSelectedPension : "disapproveSelectedPension"},
                success: function(response){
                    $("#loading").addClass("d-none");
                    if(response == "Success"){
                        Swal.fire({
                        title: 'Success!',
                        text: "Pension Request was Dispproved!",
                        icon: 'success',
                        showCancelButton: false,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
