...
<!-- Approve Burial Date Pick Modal -->
    ...
    <div class="modal-content">
      ...
      <form id="datePicker">
        <div class="form-group mt-4">
            ...
            <input type="date" class="form-control" id="datePickerInput" name="dateRelease" required>
            <input type="hidden" class="form-control" id="idSelected" name="id_item_select" required>
        </div>
      </div>
...
<script>
    ...
    $("#submitDate").click(function(){
        if($("#datePickerInput").val()==""){
          ...
          var formData = $("#datePicker").serialize()+"&approveSelectedBurialAsst=approveSelectedBurialAsst"
        Swal.fire({
        title: 'Are you sure?',
